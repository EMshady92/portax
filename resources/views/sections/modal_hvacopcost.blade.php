 ...
 <div id="modal_hvacopcost" name="modal_hvacopcost" onclick="show_info('info_porta_hvacopcost','parallaxasx_hvacopcost')"   class="bg-[#172c3d] rounded overflow-hidden  border-[3px] border-[#67788a] cursor-pointer hover:border-[#ec1c24] proyecs_sizes h-full">
    <div  class="w-full">
